    ...
    public class Configuration : ScriptableObject
    {
        ...
        public static Configuration Instance
        {
            get
            {
                ...
                Configuration configuration = AssetDatabase.LoadAssetAtPath("Assets/NUXML/Configuration/Configuration.asset", typeof(Configuration)) as Configuration;
                ...
                System.IO.Directory.CreateDirectory("Assets/NUXML/Configuration/");
                configuration = ScriptableObject.CreateInstance<Configuration>();
                AssetDatabase.CreateAsset(configuration, "Assets/NUXML/Configuration/Configuration.asset");
