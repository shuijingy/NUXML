...
namespace NUXML.Editor
{
	...
	/// </summary>
	[CustomEditor(typeof(NGUIViewPresenter))]
	public class NGUIViewPresenterInspector : UnityEditor.Editor
	{
		#region Methods
		...
		public override void OnInspectorGUI()
		{
			...
			var viewPresenter = (NGUIViewPresenter)target;

			// main view selection
			int selectedViewIndex = viewPresenter.NGUIViews.IndexOf(viewPresenter.MainView) + 1;

			// .. add empty selection
			var mainViewOptions = new List<string>(viewPresenter.NGUIViews);
			...
			viewPresenter.MainView = newSelectedViewIndex > 0 ? viewPresenter.NGUIViews[newSelectedViewIndex - 1] : String.Empty;
