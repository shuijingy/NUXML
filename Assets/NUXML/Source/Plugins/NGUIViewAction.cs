...
namespace NUXML
{
	...
	public class NGUIViewAction
	{
		...
		private List<NGUIViewActionEntry> _viewActionEntries;
		...
		/// </summary>
		public NGUIViewAction(string name = "")
		{
			Name = name;
			...
			_viewActionEntries = new List<NGUIViewActionEntry>();
		}

		/// <summary>
		/// Initializes static instance of the class.
		/// </summary>
		static NGUIViewAction()
		{
		...
		/// </summary>
		internal void AddEntry(NGUIViewActionEntry viewActionEntry)
		{
			if (_viewActionEntries == null)
			{
				_viewActionEntries = new List<NGUIViewActionEntry>();
