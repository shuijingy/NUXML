...
namespace NUXML
{
	...
	/// </summary>
	public class NGUIViewFieldBindingSource : BindingSource
	{
		#region Fields

		public NGUIViewFieldData ViewFieldData;
		...
		/// </summary>
		public NGUIViewFieldBindingSource(NGUIViewFieldData viewFieldData, bool negateValue = false)
		{
		...
		public override string BindingSourceString
		{
			get
			{
				return String.Format("{0}.{1}", ViewFieldData.SourceNGUIView.ViewTypeName, ViewFieldData.ViewFieldPath);
			}
		}
