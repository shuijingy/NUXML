    ...
    public static class ViewData
    {
        ...
        public static float ElementSize
        {
            get
            {
                if (!_isInitialized)
                {
                    Debug.LogError("[.312] ViewData used before data has been initialized.");
                }
        ...
        public static ValueInterpolator GetValueInterpolator(Type type)
        {
            if (!_isInitialized)
            {
                Debug.LogError("[.313] ViewData used before data has been initialized.");
                return null;
            }
        ...
        public static ValueConverter GetValueConverter(Type type)
        {
            if (!_isInitialized)
            {
                Debug.LogError("[.314] ViewData used before data has been initialized.");
                return null;
            }
